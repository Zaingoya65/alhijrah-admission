    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 py-5">
                <img src="assets/images/hero.jpg" alt="Al-Hijrah Students" class="img-fluid rounded shadow">
            </div>
        </div>
    </div>
</section>
...
<section id="admission" class="py-5 bg-white">
    <div class="container">
        <div class="section-header text-center mb-5">
            ...
            <p class="text-muted">Requirements for joining Al-Hijrah Trust</p>
        </div>
...
<section id="vision" class="py-5 bg-light">
    <div class="container">
        <div class="section-header text-center mb-5">
            ...
            <p class="text-muted">The three pillars of Al-Hijrah Trust</p>
        </div>
        
        <div class="row g-4">
            <div class="col-md-4">
                <div class="vision-item text-center p-4">
                    <div class="vision-icon d-flex align-items-center justify-content-center bg-primary bg-opacity-10 text-primary rounded-circle mx-auto mb-4" style="width: 100px; height: 100px;">
                        <i class="fas fa-mosque fa-2x"></i>
                    </div>
                    <h4 class="fw-bold mb-3">Islamiat</h4>
                    <p class="text-muted">Nurturing students with Islamic values, teachings, and character development to become righteous Muslims.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="vision-item text-center p-4">
                    ...
                    <h4 class="fw-bold mb-3">Insaniat</h4>
                    <p class="text-muted">Developing humanitarian values, empathy, and social responsibility to serve humanity with compassion.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="vision-item text-center p-4">
                    ...
                    <h4 class="fw-bold mb-3">Pakistaniat</h4>
                    <p class="text-muted">Instilling patriotism, national identity, and commitment to serve Pakistan with dedication and integrity.</p>
                </div>
            </div>
        </div>
    </div>
